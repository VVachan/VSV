...
<html lang="en">
  ...
  <body>
    ...
    <div class="game-heading container">
      <h1><img class="s-icon" src="home.png" type="x-icon" alt="icon" />Cyberpunk</h1>
      <!-- Cyberpunk Image -->
      <img src="home.png" alt="Cyberpunk 2077" class="game-image">
    </div>
    ...
    <div class="about container">
      <h2>
        ...
        <h2>About Cyberpunk 2077</h2>
        <p>
        <ul>
        <ol>Welcome to the world of *Cyberpunk 2077*, a futuristic open-world RPG!</ol>
        <br/>
        In Cyberpunk 2077, you play as V, a customizable mercenary in the dystopian world of Night City. Experience thrilling action, a deep narrative, and immersive gameplay as you navigate the streets of this cyberpunk universe.
        <br/><br/>
        <ol>★ Explore a vast open world filled with diverse districts, characters, and dangerous factions!</ol>
        <ol>★ Customize V’s abilities, appearance, and playstyle with a deep skill system!</ol>
        <ol>★ Engage in fast-paced combat with an arsenal of cybernetic enhancements and high-tech weapons!</ol>
        <ol>★ Immerse yourself in a branching story full of choices that impact the world around you!</ol>
        <ol>★ Play side missions that uncover hidden secrets, uncover dark conspiracies, and challenge your skills!</ol>
        <br/>
        <ol>Join the rebellion and shape your future in the dystopian world of *Cyberpunk 2077*!</ol>
        </ul>
        </p>
    </div>
    ...
    <div class="download">
      ...
      <a href="https://cyberpunk-2077.en.softonic.com/download" download class="download-button">
          <i class="bx bxs-download bx-fade-down"></i> Download Cyberpunk for Windows
      </a>
    </div>

    <!-- Scroll to Top Section -->
    <div class="up-page">
      <a href="3.php"><i class="bx bxs-chevrons-up bx-fade-up"></i></a>
    </div>
