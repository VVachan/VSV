...
<html lang="en">
  ...
  <body>
    ...
    <div class="game-heading container">
      <h1><img class="s-icon" src="menu.png" type="x-icon" alt="icon" />battlefield 2042</h1>
      <!-- Cyberpunk Image -->
      <img src="trending2.jpg" alt="Battlefield 2042" class="game-image">
    </div>
      ...
      <h2>
        <?xml version="1.0" ?><svg class="about-icon" id="Layer_1" style="enable-background:new 0 0 30 30;" version="1.1" viewBox="0 0 30 30" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M3.158,26.134C6.066,23.557,5,21,5,21l7,2c0,0-3.663,3.721-8.417,3.99L3.158,26.134z" fill="#322f40"/><circle cx="3.5" cy="26.5" r="0.5"/><path d="M15,3C7.82,3,2,7.925,2,14s5.82,11,13,11s13-4.925,13-11S22.18,3,15,3z M16,20h-2v-7h2V20z M15,10.5  c-0.828,0-1.5-0.672-1.5-1.5s0.672-1.5,1.5-1.5s1.5,0.672,1.5,1.5S15.828,10.5,15,10.5z" fill="#322f40"/>
          <svg class="about-icon" id="Layer_1" style="enable-background:new 0 0 30 30;" version="1.1" viewBox="0 0 30 30" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M3.158,26.134C6.066,23.557,5,21,5,21l7,2c0,0-3.663,3.721-8.417,3.99L3.158,26.134z" fill="#322f40"/><circle cx="3.5" cy="26.5" r="0.5"/><path d="M15,3C7.82,3,2,7.925,2,14s5.82,11,13,11s13-4.925,13-11S22.18,3,15,3z M16,20h-2v-7h2V20z M15,10.5  c-0.828,0-1.5-0.672-1.5-1.5s0.672-1.5,1.5-1.5s1.5,0.672,1.5,1.5S15.828,10.5,15,10.5z" fill="#322f40"/>
            ...
            <h2>About Battlefield 2042</h2>
            <p>
            <ul>
            <ol>Welcome to the world of *Battlefield 2042*, a high-intensity first-person shooter set in a near-future world!</ol>
            <br/>
            In *Battlefield 2042*, you experience large-scale battles with up to 128 players, featuring advanced weaponry, tactical gameplay, and dynamic environmental effects. Engage in intense warfare on expansive maps where every decision counts in the fight for survival.
            <br/><br/>
            <ol>★ Participate in massive battles with up to 128 players in large-scale environments!</ol>
            <ol>★ Use advanced futuristic weapons, drones, and vehicles to gain the upper hand in battle!</ol>
            <ol>★ Experience dynamic weather effects like sandstorms and tornadoes that impact gameplay!</ol>
            <ol>★ Work together with your team to complete objectives and dominate the battlefield!</ol>
            <ol>★ Play in various modes, including the new Hazard Zone and All-Out Warfare modes!</ol>
            <br/>
            <ol>Join the war in *Battlefield 2042*, where chaos reigns and every moment is a fight for survival!</ol>
            </ul>
            </p>
            </div>
    ...
    <div class="download">
      ...
      <a href="https://battlefield-2042.en.softonic.com/download" download class="download-button">
          <i class="bx bxs-download bx-fade-down"></i> Download battlefield 2042 for Windows
      </a>
    </div>

    <!-- Scroll to Top Section -->
    <div class="up-page">
      <a href="5.php"><i class="bx bxs-chevrons-up bx-fade-up"></i></a>
    </div>
